...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-[5px] shadow-md text-base font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
        ...
        outlineExpandIcon:
          "group relative text-foreground bg-primary hover:bg-primary/90 border border-input bg-background hover:bg-accent",
        ringHover:
...
>(
  (
    ...
    return (
      ...
      >
        {loading ? (
          <ReloadIcon className="h-6 w-6 animate-spin mx-1" />
        ) : (
          Icon &&
          iconPlacement === "left" && (
